...
/*
 * @Date: 2020-10-29 10:09:03
 * @LastEditors: aiden.deng (Zhenpeng Deng)
 * @LastEditTime: 2020-10-29 10:17:22
 *
 * @Description:
 * 1. 使用可配置的json序列化。默认使用buildin encoding/json库，可配置使用jsoniter提升性能。
 *
 */
...
func (f *JSONFormatter) Format(entry *logrus.Entry) ([]byte, error) {
	...
	// TODO(aiden.deng): 无法从entry中取出私有成员error
	// if entry.err != "" {
